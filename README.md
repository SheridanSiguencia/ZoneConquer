...
ZoneConquer is a cross-platform mobile application that gamifies real-world cycling by allowing players to claim territory using their smartphone's GPS.
...
`git clone https://github.com/SheridanSiguencia/ZoneConquer.git`
